...
- [HIT ] `DISPlay:DATA?` @ rigol_scope\scope.py:1011
- [HIT ] `*IDN?` @ rigol_scope\scope.py:147
- [HIT ] `SYSTem:VERSion?` @ rigol_scope\scope.py:151
- [HIT ] `SYSTem:ERRor?` @ rigol_scope\scope.py:155
- [HIT ] `SYSTem:BEEPer` @ rigol_scope\scope.py:173
- [HIT ] `TRIGger:STATus?` @ rigol_scope\scope.py:200
- [HIT ] `ACQuire:MDEPth` @ rigol_scope\scope.py:210
- [HIT ] `ACQuire:TYPE` @ rigol_scope\scope.py:220
- [HIT ] `ACQuire:SRATe?` @ rigol_scope\scope.py:237
- [HIT ] `CHANnel{n}:DISPlay` @ rigol_scope\scope.py:251
- [HIT ] `CHANnel{n}:SCALe` @ rigol_scope\scope.py:262
- [HIT ] `CHANnel{n}:OFFSet` @ rigol_scope\scope.py:270
- [HIT ] `CHANnel{n}:COUPling` @ rigol_scope\scope.py:279
- [HIT ] `CHANnel{n}:PROBe` @ rigol_scope\scope.py:287
- [HIT ] `CHANnel{n}:BWLimit` @ rigol_scope\scope.py:295
- [HIT ] `CHANnel{n}:IMPedance` @ rigol_scope\scope.py:307
- [HIT ] `TIMebase:MAIN:SCALe` @ rigol_scope\scope.py:315
- [HIT ] `TIMebase:MAIN:OFFSet` @ rigol_scope\scope.py:322
- [HIT ] `TRIGger:MODE` @ rigol_scope\scope.py:331
- [HIT ] `TRIGger:SWEep` @ rigol_scope\scope.py:339
- [HIT ] `TRIGger:EDGE:SOURce` @ rigol_scope\scope.py:346
- [HIT ] `TRIGger:EDGE:SLOPe` @ rigol_scope\scope.py:348
- [HIT ] `TRIGger:EDGE:LEVel` @ rigol_scope\scope.py:362
- [HIT ] `MEASure:SOURce` @ rigol_scope\scope.py:575
- [HIT ] `MEASure:ITEM` @ rigol_scope\scope.py:602
- [HIT ] `WAVeform:PREamble?` @ rigol_scope\scope.py:918
- [HIT ] `WAVeform:SOURce` @ rigol_scope\scope.py:957
- [HIT ] `WAVeform:MODE` @ rigol_scope\scope.py:958
- [HIT ] `WAVeform:FORMat` @ rigol_scope\scope.py:959
- [HIT ] `WAVeform:POINts` @ rigol_scope\scope.py:962
- [HIT ] `WAVeform:STARt` @ rigol_scope\scope.py:993
- [HIT ] `WAVeform:STOP` @ rigol_scope\scope.py:994
- [HIT ] `WAVeform:DATA?` @ rigol_scope\scope.py:995
