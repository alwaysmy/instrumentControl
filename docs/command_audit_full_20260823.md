...
- [HIT ] `WAVeform:PREamble?` @ rigol_scope\scope.py:1084
- [HIT ] `WAVeform:SOURce` @ rigol_scope\scope.py:1123
- [HIT ] `WAVeform:MODE` @ rigol_scope\scope.py:1124
- [HIT ] `WAVeform:FORMat` @ rigol_scope\scope.py:1125
- [HIT ] `WAVeform:POINts` @ rigol_scope\scope.py:1128
- [HIT ] `WAVeform:STARt` @ rigol_scope\scope.py:1159
- [HIT ] `WAVeform:STOP` @ rigol_scope\scope.py:1160
- [HIT ] `WAVeform:DATA?` @ rigol_scope\scope.py:1161
- [HIT ] `DISPlay:DATA?` @ rigol_scope\scope.py:1183
- [HIT ] `*IDN?` @ rigol_scope\scope.py:221
- [HIT ] `SYSTem:VERSion?` @ rigol_scope\scope.py:225
- [HIT ] `SYSTem:ERRor?` @ rigol_scope\scope.py:229
- [HIT ] `SYSTem:BEEPer` @ rigol_scope\scope.py:247
- [HIT ] `TRIGger:STATus?` @ rigol_scope\scope.py:274
- [HIT ] `ACQuire:MDEPth` @ rigol_scope\scope.py:284
- [HIT ] `ACQuire:TYPE` @ rigol_scope\scope.py:294
- [HIT ] `ACQuire:SRATe?` @ rigol_scope\scope.py:311
- [HIT ] `CHANnel{n}:DISPlay` @ rigol_scope\scope.py:325
- [HIT ] `CHANnel{n}:SCALe` @ rigol_scope\scope.py:336
- [HIT ] `CHANnel{n}:OFFSet` @ rigol_scope\scope.py:344
- [HIT ] `CHANnel{n}:COUPling` @ rigol_scope\scope.py:353
- [HIT ] `CHANnel{n}:PROBe` @ rigol_scope\scope.py:361
- [HIT ] `CHANnel{n}:BWLimit` @ rigol_scope\scope.py:369
- [HIT ] `CHANnel{n}:IMPedance` @ rigol_scope\scope.py:381
- [HIT ] `TIMebase:MAIN:SCALe` @ rigol_scope\scope.py:389
- [HIT ] `TIMebase:MAIN:OFFSet` @ rigol_scope\scope.py:396
- [HIT ] `TRIGger:MODE` @ rigol_scope\scope.py:405
- [HIT ] `TRIGger:SWEep` @ rigol_scope\scope.py:413
- [HIT ] `TRIGger:EDGE:SOURce` @ rigol_scope\scope.py:420
- [HIT ] `TRIGger:EDGE:SLOPe` @ rigol_scope\scope.py:422
- [HIT ] `TRIGger:EDGE:LEVel` @ rigol_scope\scope.py:436
- [HIT ] `MEASure:SOURce` @ rigol_scope\scope.py:650
- [HIT ] `MEASure:ITEM` @ rigol_scope\scope.py:677
